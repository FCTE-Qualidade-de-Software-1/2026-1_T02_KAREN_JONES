...
import csv
import statistics
from datetime import datetime  # Pra juntar com os dados de monitoria.py
...
for i in range(N_RUNS):
    ...
    monitor_file = "monitor_recursos.csv"
...
with open("resultados_brutos.csv", "w", newline="") as f:
...
with open("resultados_tratados.csv", "w", newline="") as f:
...
with open("resultados_estatisticas.csv", "w", newline="") as f:
    ...
    for metric, values in summary_values.items():
        ...
        print(f"{metric}: mean={mean} | median={median} | desvio={desvio}")